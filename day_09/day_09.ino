...
void ShowBatteryPercentage(){
  ...
  double batteryPercentage = PercentFull / 100;
  //gradually reduce Red max value by precentful
  red = 125 - (125 * batteryPercentage);
  //gradually increase Green value by precentful
  green = (125 * batteryPercentage);
