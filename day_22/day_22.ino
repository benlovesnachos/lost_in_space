// *****************************************************************************************
// Day 22 more work with the OLED display.
//
// Still have the countdown timer function working with the rotary encoder.  The purpose is
// to try and have as many functions as possible that don't block other functions.  The 
// changing of the display will not block the rotary encoder from changing the counter up
// and down.
//
// There is still work to be done to keep the countdown timer from blocking the screen.
// *****************************************************************************************
